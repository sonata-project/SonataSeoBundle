...
final class TweetGetterTest extends TestCase
{
    ...
    public function testLegacyGetUriForSettingsById(): void
    {
        $settings = [
            'tweet' => '123',
            'foo' => 'bar',
    ...
    public function testLegacyGetUriForSettingsByLink(): void
    {
        $settings = [
            'tweet' => 'https://twitter.com/dunglas/statuses/438337742565826560',
            'foo' => 'bar',
    ...
    public function testLegacyGetUriForSettingsByTweet(): void
    {
        $settings = [
            'tweet' => 'It just tweet content.',
            'foo' => 'bar',
    ...
    public function testLegacyLoadTweet(): void
    {
        $settings = [
            'tweet' => 'https://twitter.com/dunglas/statuses/438337742565826560',
            'foo' => 'bar',
